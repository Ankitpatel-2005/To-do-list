...
class GUI():
    def __init__(self,master):
        ...
        root.config(bg="#D400FF")
        root.resizable(False, False)

        self.label = Label(text=":PASSWORD GENERATOR:", anchor=N, fg='darkblue', bg="#D000FF", font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg="#AEFF00", fg='red')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg="#AAFF00", fg='red')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg="#AAFF00", fg='red')
